...
public class FixedRoutes {
    ...
    public static List<Trajectory> getAllRoutes() {
        ...
        return List.of(
                ...
                new Trajectory(denHaag, eindhoven, List.of("07:30", "12:00", "18:00"), 90, TransportType.BUS),
                new Trajectory(eindhoven, denHaag, List.of("08:45", "13:30", "19:30"), 90, TransportType.BUS),
                ...
                new Trajectory(rotterdam, denHaag, List.of("07:00", "12:30", "18:00"), 30, TransportType.BUS),
                new Trajectory(denHaag, rotterdam, List.of("08:15", "13:45", "19:30"), 30, TransportType.BUS),
                ...
                new Trajectory(denHaag, eindhoven, List.of("08:00", "13:00", "19:00"), 60, TransportType.TREIN),
                new Trajectory(eindhoven, denHaag, List.of("09:00", "14:00", "20:00"), 60, TransportType.TREIN),
                ...
                new Trajectory(rotterdam, denHaag, List.of("07:40", "11:30", "19:50"), 20, TransportType.TREIN),
                new Trajectory(denHaag, rotterdam, List.of("09:50", "14:30", "20:20"), 20, TransportType.TREIN),
